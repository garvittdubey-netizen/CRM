...
export const profileApi = {
  get: () => api.get<Profile>('/api/auth/profile').then((r) => r.data),
  update: (data: UpdateProfilePayload) =>
    api.put<Profile>('/api/auth/profile', data).then((r) => r.data),
  changePassword: (data: ChangePasswordPayload) =>
    api.put<{ ok: true }>('/api/auth/password', data).then((r) => r.data),
};
...
export const tenantSettingsApi = {
  get: () => api.get<TenantSettings>('/api/settings/tenant').then((r) => r.data),
  update: (data: UpdateTenantSettingsPayload) =>
    api.put<TenantSettings>('/api/settings/tenant', data).then((r) => r.data),
};
...
export const systemApi = {
  status: () => api.get<SystemStatus>('/api/system/status').then((r) => r.data),
};
