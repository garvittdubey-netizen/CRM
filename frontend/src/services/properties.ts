...
export const propertiesApi = {
  list: (params: PropertyListParams) =>
    api.get<PropertiesResponse>('/api/properties', { params }).then((r) => r.data),

  get: (id: string) => api.get<Property>(`/api/properties/${id}`).then((r) => r.data),

  create: (data: CreatePropertyData) =>
    api.post<Property>('/api/properties', data).then((r) => r.data),
  ...
  assign: (id: string, agentId: string | null) =>
    api.patch<Property>(`/api/properties/${id}/assign`, { agentId }).then((r) => r.data),

  matchingLeads: (id: string) =>
    api
      .get<{ leads: MatchingLead[] }>(`/api/properties/${id}/matching-leads`)
      .then((r) => r.data.leads),
};
...
export const uploadsApi = {
  cloudinarySignature: (folder = 'properties') =>
    api
      .get<CloudinarySignature>('/api/uploads/cloudinary-signature', { params: { folder } })
      .then((r) => r.data),
};
